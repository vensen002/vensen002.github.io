...
<p>参考<a href="https://www.tslang.cn/docs/home.html" target="_blank" rel="noopener noreferrer">官方文档<ExternalLinkIcon/></a>
<a href="https://gitee.com/jiuyueqi/class" target="_blank" rel="noopener noreferrer">行业大佬整理文档以及源码<ExternalLinkIcon/></a></p>
<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2>
<ul>
<li>TS是由微软2012年开发的一款开源的编程语言</li>
<li>TypeScript 是 Javascript 的超集，遵循最新的 ES6、ES5规范。TypeScript 扩展了 JavaScript的语法</li>
<li>在 js 的基础上，为js添加了<strong>类型支持</strong></li>
</ul>
<h2 id="设计目标" tabindex="-1"><a class="header-anchor" href="#设计目标" aria-hidden="true">#</a> 设计目标</h2>
<ul>
<li>遵循当前以及未来出现的ECMAScript规范</li>
<li>开发大型应用，可以编译成纯JavaScript，编译出来的JavaScript可以运行在浏览器上</li>
<li>成为跨平台的开发工具，TypeScript使用Apache作为开源协议，且能够再所有主流的操作系统上安装和执行</li>
</ul>
<h2 id="ts优势" tabindex="-1"><a class="header-anchor" href="#ts优势" aria-hidden="true">#</a> TS优势</h2>
<ul>
<li>更早的发现错误</li>
<li>任何位置都有代码提示，增加开发效率</li>
<li>类型系统提升了代码的可维护性，重构更容易</li>
<li>使用最新的ECMAScript语法</li>
<li>ts类型推断机制，降低成本</li>
</ul>
<h2 id="ts劣势" tabindex="-1"><a class="header-anchor" href="#ts劣势" aria-hidden="true">#</a> TS劣势</h2>
<ul>
...
<h2 id="ts与js的区别" tabindex="-1"><a class="header-anchor" href="#ts与js的区别" aria-hidden="true">#</a> TS与JS的区别</h2>
<table>
<thead>
<tr>
<th>JavaScript</th>
...
<h2 id="ts环境安装与初体验" tabindex="-1"><a class="header-anchor" href="#ts环境安装与初体验" aria-hidden="true">#</a> TS环境安装与初体验</h2>
<h3 id="安装与运行" tabindex="-1"><a class="header-anchor" href="#安装与运行" aria-hidden="true">#</a> 安装与运行</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code>tsc 文件名称<span class="token punctuation">.</span>ts
tsc <span class="token operator">--</span>watch
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="js缺陷演示" tabindex="-1"><a class="header-anchor" href="#js缺陷演示" aria-hidden="true">#</a> js缺陷演示</h3>
